...
public class ClockWithGUI extends JPanel {
  ...
  public void paintComponent(Graphics g) {
    ...
    int numberDistance = (int) (CLOCK_SIZE * 0.43);
    int hourHandLength = (int) (CLOCK_SIZE * 0.25);
    int secondHandLength = (int) (CLOCK_SIZE * 0.4);
    int minuteHandLength = (int) (CLOCK_SIZE * 0.30);
